...
golem::fill_desc(
  ...
  pkg_title = "Testing package", # The Title of the package containing the App 
  pkg_description = "My first golem shiny app!", # The Description of the package containing the App 
...
## 1.5 : Use Recommended Packages (adds as a dependency to shiny app)
...
# Or do this to add another R file
usethis::use_r()
