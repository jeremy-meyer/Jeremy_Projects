...
paths = [
  'weather/slc_daily_weather/1994-2009.csv',
  'weather/slc_daily_weather/2010-2014.csv',
  'weather/slc_daily_weather/2015-2018.csv',
  'weather/slc_daily_weather/2019.csv',
  'weather/slc_daily_weather/2020-2025.csv',
]
...
sun_times = (
  pd.read_csv('weather/slc_daily_weather/sunrise_set.csv')
...
hourly_combined.to_csv('weather/slc_daily_weather/slc_hourly_weather.csv', index=False)
